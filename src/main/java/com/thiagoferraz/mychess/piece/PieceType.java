...
public enum PieceType {
    ...
    Queen(5, 9, "Queen", "The most powerful piece on the chessboard. Each player starts with one queen. The queen can move horizontally, vertically, and diagonally in any direction."),
    King(6, 100, "King", "The most powerful piece on the chessboard. Each player starts with one queen. The queen can move horizontally, vertically, and diagonally in any direction.");
